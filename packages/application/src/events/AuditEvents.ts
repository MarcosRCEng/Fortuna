export enum AuditEventType {
  ...
  MARKET_DATA_REAL_PROVIDER_SELECTED = "MARKET_DATA_REAL_PROVIDER_SELECTED",
  MARKET_DATA_QUOTE_FETCHED = "MARKET_DATA_QUOTE_FETCHED",
  MARKET_DATA_FALLBACK_USED = "MARKET_DATA_FALLBACK_USED",
  MARKET_DATA_CACHE_USED = "MARKET_DATA_CACHE_USED",
